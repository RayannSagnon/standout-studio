  ...
  projects: [
    {
      ...
      category: "business",
      categoryLabel: "Cafe & Hospitality",
      description: "Artisanal bakery and specialty coffee shop in Ottawa, showcasing custom menu curation and brand warmth.",
      featured: true,
    },
    {
      id: "sharp",
      ...
      category: "personal",
      categoryLabel: "Coaching & Fitness",
      description: "High-impact athletic coaching showcase with dynamic typography and bold visual identity.",
      featured: true,
    },
    {
      id: "rayann",
      ...
      category: "personal",
      categoryLabel: "Engineering Portfolio",
      description: "Creative developer portfolio highlighting web architecture, UI craft, and performance-first execution.",
      featured: true,
    },
    {
      id: "steven",
      ...
      category: "personal",
      categoryLabel: "Design & Direction",
      description: "Design and strategy portfolio focused on digital product aesthetics, branding, and storytelling.",
      featured: true,
    },
    {
      id: "ori-atelier",
      ...
      description: "Minimalist architectural and interior design studio portfolio with refined editorial grid structure.",
      featured: false,
    },
  ],
} as const;
