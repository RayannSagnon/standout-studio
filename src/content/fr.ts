  ...
  projects: [
    {
      ...
      image: "/work/caramello-desktop.webp",
      imageMobile: "/work/caramello-mobile.webp",
      category: "business",
      categoryLabel: "Café & Restauration",
      description: "Pâtisserie artisanale et café de spécialité à Ottawa, avec menu interactif et identité chaleureuse.",
      featured: true,
    },
    {
      id: "sharp",
      ...
      description: "Plateforme percutante de coaching sportif avec typographie dynamique et identité visuelle affirmée.",
      featured: true,
    },
    {
      id: "rayann",
      ...
      category: "personal",
      categoryLabel: "Portfolio Ingénierie",
      description: "Portfolio de développeur créatif mettant en avant l'architecture web moderne et la précision d'interface.",
      featured: true,
    },
    {
      id: "steven",
      ...
      category: "personal",
      categoryLabel: "Design & Stratégie",
      description: "Portfolio de design et direction artistique axé sur les produits numériques, le branding et l'expérience.",
      featured: true,
    },
    {
      id: "ori-atelier",
      ...
      description: "Portfolio d'atelier d'architecture et design d'intérieur avec structure éditoriale minimaliste.",
      featured: false,
    },
  ],
};
 ...
 plans: [
  ...
  },
  {
    ...
    features: [
      ...
      "Design personnalisé et responsive",
      "Parcours pensé pour convertir",
      "SEO local + analytique",
  ...
  },
  {
    ...
    featured: false,
    features: [
      "Site web de 6 à 10 pages",
      "UX/UI entièrement personnalisé",
      "Parcours client avancé",
      "SEO avancé + analytique",
